        ...
        <div
            ...
            <form id="createForm" method="post" action="/edit/{{ $invoice->id }}" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="number" id="quantity" name="quantity" value="{{ $invoice->quantity }}"
                ...
                <div class="mb-6">
                    <label for="datepicker" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Invoice
                        date</label>
                    <input type="text" id="datepicker" name="invoice_date" value="{{ $invoice->invoice_date }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        required>
                    @error('invoice_date')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                ...
                <div class="mb-6">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file">Upload
                        file</label>
                    <input type="file" id="file" name="file" value="/storage/{{ $invoice->file }}"
